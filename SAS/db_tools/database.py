...
cur.execute("CREATE TABLE album_artist(album_artist_id TEXT, album_artist TEXT, \
    PRIMARY KEY(album_artist_id))")

cur.execute("CREATE TABLE album(album_id TEXT, album_artist_id TEXT, album TEXT, \
    PRIMARY KEY(album_id), FOREIGN KEY(album_artist_id) REFERENCES album_artist(album_artist_id))")

cur.execute("CREATE TABLE track(track_id TEXT, album_id TEXT, title TEXT, track INT, disc INT, \
